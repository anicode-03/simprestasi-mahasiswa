...
<head>
    ...
    <title>Login Mahasiswa - SIM Prestasi</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body class="bg-gray-100 flex items-center justify-center h-screen">
    <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        <h2 class="text-2xl font-bold mb-6 text-center text-gray-800">Login Mahasiswa</h2>
        ...
        <div class="mt-4 text-center">
            <a href="{{ route('admin.login') }}" class="text-sm text-blue-600 hover:underline">Login sebagai Admin?</a>
        </div>
    </div>
</body>
</html>