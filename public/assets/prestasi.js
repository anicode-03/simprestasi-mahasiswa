...
// =============================================
// RENDER CARDS
// Dipakai di halaman beranda DAN halaman kategori.
// - Di beranda  : tidak ada filter kategori & resultCount, langsung render semua.
// - Di kategori : filter kategori aktif + tampilkan resultCount.
// =============================================
function renderCards(filterText = "") {
    ...
    const filtered = dataPrestasi.filter(item => {
        const matchesSearch =
            ...
            item.nim.toLowerCase().includes(filterText.toLowerCase()) ||
            item.prodi.toLowerCase().includes(filterText.toLowerCase());

        // Filter kategori hanya aktif jika bukan "Semua"
        const matchesCategory = (currentCategory === "Semua") || (item.kategori === currentCategory);

        return matchesSearch && matchesCategory;
    });

    // Update jumlah hasil (hanya ada di halaman kategori)
    const resultCount = document.getElementById('resultCount');
    if (resultCount) {
        resultCount.innerText = `Menampilkan ${filtered.length} Prestasi`;
    }
...
// =============================================
// FILTER KATEGORI (hanya aktif di halaman kategori)
// =============================================
...
// =============================================
// SWIPER QUOTE (hanya aktif di halaman beranda)
// =============================================
function initSwiper() {
