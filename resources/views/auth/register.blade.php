                ...
                <div class=" mb-5">
                    ...
                    <div class="flex justify-center">
                        <div class="auth-toggle">
                            <a href="login.php" class="toggle-inactive">LOGIN</a>
                ...
                <form action="{{ route(register) }}" method="POST" class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="nim" class="input-field" placeholder="E412xxxx" required>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="email" name="email" class="input-field" placeholder="e412xxxx@student.polije.ac.id" required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="hp" class="input-field" placeholder="08123xxxxxxx" required>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="password" name="konfirmasi_password" class="input-field" placeholder="••••••••" required>
                        </div>
                    </div>

                    <!-- Persetujuan -->
                    <div class="flex items-center space-x-3 p-4 bg-slate-50 rounded-2xl border border-slate-100">
                        <input type="checkbox" id="agree" class="w-5 h-5 rounded border-gray-300 text-blue-900 focus:ring-blue-900 cursor-pointer" required>
                    ...
                    <p class="text-center mt-10 text-sm text-gray-500 font-medium">
                        Sudah Punya Akun? <a href="login.php" class="text-blue-900 font-extrabold hover:underline">Masuk Disini</a>
                    </p>
                </form>
            </div>
        </div>
