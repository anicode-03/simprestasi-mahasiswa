    ...
    <div class="w-[45%] flex flex-col">
        <div class="profile-card flex flex-col items-center">
            <div class="profile-img-container">
                <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Ani" class="w-full h-full object-cover" alt="Foto profil">
            </div>
                    ...
                    <div class="group relative flex gap-4 p-4 rounded-2xl hover:bg-blue-50 border border-transparent hover:border-blue-100 transition-all mb-3">
                        ...
                        <div>
                            <div class="flex items-center gap-2 mb-1">
                                ...
                                <span class="text-[10px] font-bold text-slate-400 uppercase tracking-tighter">{{ $riwayat->tingkat }}</span>
                            </div>
                            <h4 class="font-bold text-slate-800 text-sm leading-snug">{{ $riwayat->nama_lomba }}</h4>
                            <p class="text-xs text-slate-500 mt-1">{{ $riwayat->penyelenggara }} • {{ $riwayat->lokasi }} ({{ $riwayat->tahun }})</p>
                        </div>
                    </div>
                @empty
